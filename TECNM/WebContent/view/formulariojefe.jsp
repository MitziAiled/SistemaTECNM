...
<%@page import="controller.conexion,model.*,dao.*"%> 
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8" />
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edición de Jefe</h1>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-body">
                                        <form action="agregarnuevojefe.jsp" method="post">
                                        <%  
											String clavecarrera=request.getParameter("clavecarrera");  
											carrera u=carreraDAO.getRecordById(clavecarrera);  
										%>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="clavecarrera">Clave de la Carrera</label>
                                                        <input class="form-control py-4" name="clavecarrera" id="clavecarrera" type="text" value="<%=clavecarrera %>" readonly/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="jefe">Jefe de Carrera</label>
