...
<html lang="en">
    <head>
        ...
        <title>Maestros pos carrera</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="actualizajefe.jsp">Consulta y Modificacion</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Registrar Maestro por Carrera</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En el siguiente apartado podra elegir el o los maestros que desea asignar
                            a una carrera en específico que ya fue creada con anterioridad.</li>
                        </ol>
                        <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-body">
                                        <form action="agregarmaestro.jsp" method="post">
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
														...
														try{
											                ...
											                while (conex.rt.next()){
											                    out.println("<option>"+conex.rt.getString(2)+"</option>");
											                }
											                }catch(Exception e){
                                            ...
                                            <div class="form-group">
                                                <label class="small mb-1" for="maestro">Maestro a elegir</label>
                                                <select name="maestro" class="form-control">
													...
													try{
														...
														conexi.st=conex.conec.createStatement();
										                conexi.rt=conex.st.executeQuery(sql);
										                while (conex.rt.next()){
                                            ...
                                            <div class="form-group mt-4 mb-0"><button class="btn btn-primary btn-block" href="agregarmaestro.jsp">Registrar</a></div>
                                        </form>
                                    </div>
                                </div>
                            </div>
