            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Consulta y Modificación de Carrera</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En el siguiente apartado podrá modificar el jefe de la carrera que desee.</li>
                        </ol>
                        <div class="container">
                        <div class="container-fluid">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <%  
								List<carrera> list = carreraDAO.getAllRecords();  
								...
								%>
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
											...
											<tr>
												<td>${u.getClavecarrera()}</td>
												<td>${u.getCarrera()}</td>
												<td>${u.getJefe()}</td>  
												<td><a href="formulariojefe.jsp?clavecarrera=${u.getClavecarrera()}">Editar</a></td>
											</tr>  
										</c:forEach>
                                        </tbody>
                                    </table>
