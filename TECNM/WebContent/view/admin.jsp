                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Bienvenido administrador, 
                            en el presente sistema podra realizar varias actividades como las siguientes: 
                            Registrar una carrera nueva, Asignarle un jefe a la carrera que creó y asignarle los maestros
                            que participarar en la carrera que registro.</li>
                        </ol>
                </main>
            </div>
        </div>
