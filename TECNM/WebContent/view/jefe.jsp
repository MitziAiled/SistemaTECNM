                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="perfiljefe.jsp">
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Bienvenido jefe de carrera, 
                            en el presente sistema podra realizar varias actividades como las siguientes: 
                            Registra, eliminar, consultar o modificar una materia por carrera; 
                            Cargar un archivo csv con las materia que desee dar de alta;
                            Ver la sabana de materias por la carrera en la que sea el jefe y
                            Ver reportes de los maestros que estan en la misma carrera en la que usted es jefe .</li>
                        </ol>
                </main>
            </div>
        </div>
